...
//in ADC1 points
#define DATA_PROC_LOGIC_PROBE_BIG_DIFF_THRESHOLD 15
...
//printf(" %i \r\n",   logic_probe_results[i]);   //-------------------------------------------------------------------------------------------------------
 ...
 // printf(" %i %i %i --- %i\r\n",  big_diff_cnt, low_diff_cnt, DATA_PROC_LOGIC_PROBE_HPERIODS_NUM/2,logic_probe_results[0] );   //-------------------------------------------------------------------------------------------------------
